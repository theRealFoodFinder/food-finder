...
// const renderResults = this.state.results.map((recipe, i, array)=>{
//     return (<img key={i} onClick={this.handleImgClick} alt='' src={recipe.hero_photo_url}/>);
// }
        return (
            <div className='resultsContainer'>
              ...
              <img onClick={this.handleImgClick} alt='' src={this.state.results[0].hero_photo_url}/>{this.state.results[0].title}
              {/* {renderResults} */}
